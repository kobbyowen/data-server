...
class TestCSVAdapter(unittest.TestCase):
    ...
    def test_warning_when_not_csv_file_extension(
        self, open_mock: mock.MagicMock, os_patch: mock.MagicMock, warn_patch: mock.MagicMock
    ) -> None:
    ...
    def test_save_data(
        self,
        open_patch: mock.MagicMock,
        os_patch: mock.MagicMock,
    ) -> None:
