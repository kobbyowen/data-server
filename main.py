...
parser = ArgumentParser("Data Server", "Spin up a full fake REST API with no coding in less than 3 \
                            seconds using JSON , CSV file as the source.")

arguments = parser.get_parsed_arguments()

request_handler = DataRouter(arguments["file"], id_name=arguments["id_name"],
