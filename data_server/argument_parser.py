...
class ArgumentParser:
    def __init__(self, program_name: t.Text, program_description: t.Text = "",
                 program_epilog: t.Text = "", arguments: t.Optional[t.List[t.Text]] = None) -> None:
        ...
        self._arg_parser = argparse.ArgumentParser(
            prog=self.program_name, usage="data_server file [options]", description=self.program_description,
    ...
    def _add_server_arguments(self) -> None:
        ...
        self._arg_parser.add_argument("--host", default="127.0.0.1",
                                      help="The host the server runs on. Defaults to %(default)s")
        self._arg_parser.add_argument("--port",  default=2000, type=int,
        ...
        self._arg_parser.add_argument("--static-url-prefix", default="static",
                                      help="The url path prefix used to serve static file")
        self._arg_parser.add_argument("--url-path-prefix", default="",
        ...
        self._arg_parser.add_argument(
            "--additional-headers", help="Additional headers to add to every response. header items are separated"
            "by semi-colon, each key and value are separated by colon.Example, X-Limit:20;X-Range:30")
        self._arg_parser.add_argument("--sleep-before-request", default=0, type=int,
    ...
    def _add_controller_arguments(self) -> None:
        self._arg_parser.add_argument(
            "--page-size", default=10, type=int, help="The default page size. Can be changed by using 'size'")
        self._arg_parser.add_argument("--page-param-name", default="page",
                                      ...
                                      " Pages start from 0")
        self._arg_parser.add_argument("--sort-param-name", default="sort_by",
        ...
        self._arg_parser.add_argument("--order-param-name", default="order",
        ...
        self._arg_parser.add_argument("--size-param-name", default="size",
        ...
        self._arg_parser.add_argument("--created-at-key-name", default="created_at",
        ...
        self._arg_parser.add_argument("--updated-at-key-name",  default="updated_at", help="The updated at key name."
        ...
        self._arg_parser.add_argument("--id-name", default="id",
                                      help="The name of key for denoting the id of a resource. Defaults to %(default)s")
        self._arg_parser.add_argument("--auto-generate-ids", type=bool, default=True, help="Determines whether ids"
        ...
        self._arg_parser.add_argument("--use-timestamps", type=bool, default=True, help="Determines whether"
    ...
    @staticmethod
    def extract_keys(dictionary: t.Dict[t.Text, t.Any], keys: t.List[t.Text]) -> t.Dict[t.Text, t.Any]:
        new_dict = {}
        for key in keys:
    ...
    def get_parsed_server_arguments(self) -> t.Dict[t.Text, t.Any]:
        return self.extract_keys(
            dict(self.parsed_args._get_kwargs()), ["file", "host", "port", "static_folder",
                                                   "static_url_prefix", "additional_headers",
                                                   "sleep_before_request", "url_path_prefix"])

    def get_parsed_controller_arguments(self) -> t.Dict[t.Text, t.Any]:
        return self.extract_keys(
            dict(self.parsed_args._get_kwargs()), ["page_size", "page_param_name", "sort_param_name",
                                                   "order_param_name", "size_param_name",
                                                   "created_at_key_name", "updated_at_key_name",
                                                   "id_name", "auto_generate_ids",
                                                   "use_timestamps"])
